...
module.exports = "<h2 class=\"text-center\">Log-Form</h2>\n<div class=\"card card-body mb-3\">\n  <form (ngSubmit)=\"onSubmit()\">\n    <div class=\"form-group\">\n      <input type=\"text\" class=\"form-control\" name=\"text\" [(ngModel)]=\"text\" placeholder=\"add a log...\">\n    </div>\n    <input type=\"submit\" name=\"\" id=\"\" value=\"Add Log\" class=\"btn btn-light\" [disabled]=\"!this.text\">\n    <button (click)=\"clearState()\" type=\"button\" class=\"btn btn-warning\" [hidden]=\"!this.text\">Clear</button>\n  </form>\n</div>"
...
var LogService = /** @class */ (function () {
    function LogService() {
        ...
        // ];
        // SOURCE
        this.logSource = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["a" /* BehaviorSubject */]({
            id: null,
            text: null,
            date: null
        });
        //ACTUAL OBSERVABLE Properties
    ...
    LogService.prototype.addLog = function (log) {
        ...
        // Add to local storage: only stores strings
